...
let myWallet01 = new ethers.Wallet("0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80", provider);

// myWallet01 = myWallet.connect(provider);
...
async function deployContract() {
  const volcanoContract = await ethers.getContractFactory("VolcanoCoin", myWallet01);
...
// let myWallet02 = new.ethers.Wallet("0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d", provider);
// new ethers.Wallet.fromMnemonic("word1 word2 ... etc.") import wallet from mneumonic instead of private key
...
async function connectToContract() {
  let contractAddr = "0x23618e81e3f5cdf7f54c3d65f7fbc0abf5b21e8f";

  const volcanoContract = await ethers.getContractAt("VolcanoCoin", contractAddr, myWallet01);
  ...
  console.log("owner balance:", ownerBalance.toString());
  console.log("other user balance after transfer:", otherUserBalance.toString());

  let refundTx = await volcanoContract.connect(myWallet02).transfer(myWallet01.address, 20);
  await refundTx.wait();
  ...
  console.log(volcanoContract.symbol)
}
